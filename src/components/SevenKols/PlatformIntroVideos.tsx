          ...
          <div key={video.id} className="group cursor-pointer">
            <div className="relative aspect-video bg-gradient-to-br from-[#1a2a3a] to-[#0d1520] rounded-xl overflow-hidden mb-3">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-14 h-14 rounded-full bg-black/50 border-2 border-white/30 flex items-center justify-center group-hover:bg-black/70 group-hover:border-[#00FFD1]/50 transition-all duration-300">
            ...
            <h4 className="text-white text-sm font-medium mb-1 group-hover:text-[#00FFD1] transition-colors">
              {video.title}
            </h4>
